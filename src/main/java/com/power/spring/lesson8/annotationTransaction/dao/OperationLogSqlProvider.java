...
import com.power.spring.lesson8.annotationTransaction.model.OperationLogExample.Criteria;
import com.power.spring.lesson8.annotationTransaction.model.OperationLogExample.Criterion;
...
public class OperationLogSqlProvider {
    ...
    public String countByExample(OperationLogExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("t_oplogs");
    ...
    public String insertSelective(OperationLog record) {
        ...
        if (record.getOpTime() != null) {
            sql.VALUES("op_time", "#{opTime,jdbcType=TIMESTAMP}");
        }
        
        if (record.getOpId() != null) {
            sql.VALUES("op_id", "#{opId,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getOpTime() != null) {
            sql.SET("op_time = #{record.opTime,jdbcType=TIMESTAMP}");
        }
        
        if (record.getOpId() != null) {
            sql.SET("op_id = #{record.opId,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(OperationLog record) {
        SQL sql = new SQL();
        sql.UPDATE("t_oplogs");
        ...
        if (record.getOpTime() != null) {
            sql.SET("op_time = #{opTime,jdbcType=TIMESTAMP}");
        }
        
        if (record.getOpId() != null) {
            sql.SET("op_id = #{opId,jdbcType=INTEGER}");
        }
